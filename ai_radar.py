...
# --- rest of your Claude code for tabs remains unchanged ---

# TAB 5: AI Playbooks (modified to include auto plays expanders)
with tabs[4]:
    ...
    with col1:
        st.caption("AI scans your watchlist + movers for setups")
    with col2:
